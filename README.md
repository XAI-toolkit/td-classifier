...
Once the server is running, you can either exploit the TD Classifier APIs directly via direct requests, or setup the SDK4ED platform locally (more info [here](https://gitlab.seis.iti.gr/sdk4ed-wiki/wiki-home/wikis/home)) to benefit from the already implemented user-friendly TD Classifier frontend.